...
#ds-wrapper #ds-reset .ds-dialog-footer,#ds-thread #ds-reset .ds-meta,.ds-powered-by,.ds-toolbar-buttons,.ds-post-likes,.ds-post-repost,.ds-post-report,.ds-icon-reply,#ds-thread #ds-reset .ds-toolbar,#ds-thread #ds-reset ul.ds-comments-tabs .ds-service-icon,#ds-indicator {
...
#ds-reset .ds-rounded-top,#ds-thread #ds-reset li.ds-tab a,#ds-thread #ds-reset #ds-bubble,#ds-reset .ds-avatar img,#ds-wrapper #ds-reset .ds-control-group input,#ds-wrapper #ds-reset button,#ds-wrapper #ds-reset .ds-dialog-inner,#ds-thread #ds-reset .ds-post-button {
...
<article class="mod-post mod-post__type-post">
	<header>
		<h1 class="mod-post__title hvr-underline-from-left"><?php the_title(); ?></h1>
	</header>
...
<?php $custom_fields = get_post_custom_keys($post_id);
	...
	<div class="postcopyright">
	    <p><strong> ©声明: </strong> 本站原创文章采用<a href="http://creativecommons.org/licenses/by-nc-sa/3.0/deed.zh" title="CC-BY-NC-SA">CC-BY-NC-SA</a>协议，若需转载请以链接形式标明本文地址。</p>
	</div>
   <?php else: ?>
	...
	<ul class="sxwk">
		<li class="hvr-grow"><?php previous_post_link( '下一篇：%link', '%title', true );?></li><br>
                <li class="hvr-grow"><?php next_post_link( '上一篇：%link', '%title', true );?></li>
	</ul>
        </section> 
</article>
